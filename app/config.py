...
class Settings(BaseSettings):
    service_role: str = "autoscaler-service"
    service_name: str = "autoscaler_service"
    service_title: str = "Autoscaler service"
    service_description: str = "Owns autoscaling policies, Prometheus metric reads and replica patch decisions."
